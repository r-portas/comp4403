...
public abstract class Type 
{
    ...
    /** Name of type for error messages and for teh name in IdRefTypes */
    ...
    public static class ProcedureType extends Type {
        ...
        /** result type for a function or null */
        Type resultType; 
        public ProcedureType() {
            ...
            this.resultType = Type.VOID_TYPE;
        }
        ...
        public ProcedureType resolveType( Location loc ) {
            if ( ! resolved ) {
                for( SymEntry param : formalParams ) {
                    param.setType( param.type.resolveType( loc ) );
                }
                if( resultType != null ) {
                    resultType = resultType.resolveType( loc );
                }
